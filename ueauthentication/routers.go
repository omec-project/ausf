...
func getRoutes() []Route {
	return []Route{
		...
		},
		{
			...
			HTTPProseAuthenticationsPost,
		},
		{
			"RgAuthenticationsPost",
			http.MethodPost,
			"/rg-authentications",
			HTTPRgAuthenticationsPost,
		},
		{
		...
		},
		{
			...
			HTTPUeAuthenticationsDeregisterPost,
		},
		{
