...
FROM alpine:3.23@sha256:25109184c71bdad752c8312a8623239686a9a2071e8825f20acb8f2198c3f659 AS ausf
...
LABEL org.opencontainers.image.source="${VCS_URL}" \
    ...
    org.opencontainers.image.title="ausf" \
    org.opencontainers.image.description="Aether 5G Core AUSF Network Function" \
